...
TEST(SquareTest, SquareFromFileRank) {
    EXPECT_EQ(
        chess::square_from_file_rank(chess::File::FILE_A, chess::Rank::RANK_1),
        chess::Square::A1
    );
    EXPECT_EQ(
        chess::square_from_file_rank(chess::File::FILE_H, chess::Rank::RANK_8),
        chess::Square::H8
    );
    EXPECT_EQ(
        chess::square_from_file_rank(chess::File::FILE_E, chess::Rank::RANK_4),
        chess::Square::E4
    );
}
