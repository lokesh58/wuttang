...
enum class Piece : std::uint8_t {
  WHITE_PAWN = internal::get_piece_encoded_value(Color::WHITE, PieceType::PAWN),
  WHITE_KNIGHT =
  ...
  WHITE_ROOK = internal::get_piece_encoded_value(Color::WHITE, PieceType::ROOK),
  WHITE_QUEEN =
      internal::get_piece_encoded_value(Color::WHITE, PieceType::QUEEN),
  WHITE_KING = internal::get_piece_encoded_value(Color::WHITE, PieceType::KING),
  BLACK_PAWN = internal::get_piece_encoded_value(Color::BLACK, PieceType::PAWN),
  BLACK_KNIGHT =
  ...
  BLACK_ROOK = internal::get_piece_encoded_value(Color::BLACK, PieceType::ROOK),
  BLACK_QUEEN =
